	...
	cases: [
		{
			...
			"blocks": [
				...
				},
				{
					"block_type": "text",
					"title": "",
					"text": "<h2>Итог теста — ниже стоимость клика, ниже стоимость за&nbsp;1 000 показов и&nbsp;за&nbsp;ействие.</h2> <p>Кампания в VK AdBlogger продолжалась с 4 октября по 8 января. За это время выросло число просмотров карточки товара, добавлений в корзину и продаж. А главное — снизились целевые стоимости заказа и добавления в корзину.</p>"
				},
				{
					"block_type": "gallery",
					"images": [
