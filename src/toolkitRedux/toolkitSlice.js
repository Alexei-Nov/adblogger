...
const defaultState = {
			...
			"blocks": [
				...
				},
				{
					...
					"block_state": {
						"faqList": [
							{
								"question": "Что такое шопсы?",
								"answer": "Что такое шопсы?"
							},
							{
							...
							{
								"question": "Где я могу почитать подробнее об инструменте?",
								"answer": '<p>Где я могу почитать подробнее об инструменте?</p>'
							},
							// {
							// 	"question": "Зачем заполнять реквизиты?",
							// 	"answer": "После регистрации личного кабинета или авторизации и перед тем, как пополнить баланс рекламного кабинета и создать посев, рекламодателю нужно указать свои юридические реквизиты.<br><br>Все рекламодатели без исключения должны заполнить реквизиты. Набор полей здесь отличается в зависимости от типа аккаунта: ООО, ИП.<br><br>Заполнение реквизитов необходимо для:  <ul><li>получения закрывающих документов;</li> <li>пополнения баланса рекламного кабинета;</li> <li>автоматической маркировки рекламы</li></ul>"
	...
	cases: [
		...
		},
		{
			...
			"title": "Как авторы ВКонтакте за месяц увеличили заработок на 6,5 млн ₽ за счет нативного контента",
			...
			"blocks": [
				...
				},
				{
					"block_type": "text",
					"title": "",
					"text": "<p>Если ли вы пишете атмосферные посты, снимаете ли яркие клипы или делитесь полезными лайфхаками — вы уже готовы к сотрудничеству с крупными брендами! Начните монетизировать свой талант и контент вместе с платформой VK AdBlogger уже сегодня.</p>"
				},
			]
		},
		{
