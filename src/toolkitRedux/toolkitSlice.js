					...
					"block_state": {
						...
						"items_list": [
							...
							},
							{
								...
								"title": "Получайте высокий ROMI",
								"desc": "Низкие цены на размещение и&nbsp;высокая эффективность кампаний обеспечит отличную отдачу от&nbsp;инвестиций",
							},
							{
								"icon_path": "./img/connect/icon-3.svg",
								"title": "Опережайте конкурентов",
								"desc": "Используйте новый канал и&nbsp;получайте конкурентное преимущество",
							}
						]
					}
				},
