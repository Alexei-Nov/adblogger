					...
					"block_state": {
						"faqList": [
							...
							},
							{
								...
								"answer": '<p> Да, профили могут зарабатывать на шопсах — через раздел «Товары». Он доступен только тем страницам, которые подходят под критерии программы: не менее 1000 подписчиков, не менее 1 поста или клипа за последние 30 дней. Также, у вас должна быть оформлена самозанятость. </p> <p> Другие способы заработка в VK AdBlogger личным страницам недоступны. </p>'
							},
							{
