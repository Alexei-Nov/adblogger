			...
			"blocks": [
				...
				},
				{
					...
					"block_state": {
						...
						"list": [
							{
								"text": "У&nbsp;вас есть самозанятость, ИП <br class='br-desktop'> или&nbsp;юридическое лицо"
							},
							{
								"text": "Открытое сообщество <br class='br-desktop'> от 1&nbsp;000 подписчиков"
							},
							{
						...
						"review_list": [
							{
								...
								"text": "<p> Когда выбирала товары для рекламы, опиралась на их практичность и актуальность для моего блога. Аудитория хорошо приняла и посты, и клипы, но мне <span class='blue-text'>проще включать рекламу в скетчи</span> — короткие юмористические сценки на актуальные темы. </p> <p> Это самый популярный формат у подписчиков: именно клипы-скетчи набрали больше всего просмотров — <span class='blue-text'>и с них случились продажи.</span> </p>",
							},
							{
							...
							},
							{
								...
								"text": "<p> Большинство подписчиков младше 30, поэтому брал близкие им товары. <br> Мой контент состоит из видео, поэтому <span class='blue-text'>рекламу делал в клипах</span>. </p> <p> Публикаций было много, <span class='blue-text'>менял подход и подводки</span>: для кружки — про чаепитие, для одежды — про то, как собрать лук. </p> <p> Самый удачный клип — с рекламой кофейных зёрен: показал своё утро, как готовлю кофе: <span class='blue-text'>личная история всегда цепляет</span>. </p>",
							},
							{
							...
							},
							{
								...
								"text": "<p> Мой блог — о русском языке: думала, будет сложно интегрировать товары. </p> <p> Оказалось, женская аудитория готова воспринимать рекламу со знакомыми вещами: <span class='blue-text'>чаще всего покупали одежду</span>. Для выбора следующего продукта я анализировала отклик, репосты, переходы и покупки, а лучшая реакция была на <span class='blue-text'>клип с неожиданной концовкой</span>. </p>",
							},
							{
					...
					"block_state": {
						"faqList": [
							...
							},
							{
								...
								"answer": '<ol> <li> Перейдите в раздел «Заявки» и найдите ту, которую хотите удалить </li> <li> Откройте заявку и нажмите на три точки в правом верхнем углу, затем «Отклонить заявку». Пост удалится автоматически, а чтобы удалить клип — напишите в <a href="https://vk.me/club225265420" target="_blank">Поддержку</a>. </li> </ol> <p> После этого вы сможете брать в работу на 1 заявку меньше — в месяц и одновременно. Ограничение будет действовать до конца текущего месяца. </p>'
							},
							{
							...
							},
							{
								...
								"answer": '<ul> <li> Создавайте нативный контент: публикации с товарами должны гармонично вписываться в ваше сообщество. Чем креативнее интеграция, тем больше интереса она вызовет. </li> <li> Используйте сторителлинг и рассказывайте о личном опыте: чем вам понравился товар, какие проблемы решил и так далее. Истории вызывают эмоции — это поможет подписчикам увидеть реальную ценность продукта. </li> <li> Снимайте привлекательные фото и видео: так читатели подробнее изучат товар и быстрее решатся на покупку. Не забывайте показывать товар в действии и снимать его с разных ракурсов. </li> </ul> <p> Больше советов по созданию и продвижению контента можно найти в <a href="https://vk.com/@adblogger-baza-znanii-soco" target="_blank">Базе знаний для авторов</a>. </p>'
							},
							{
								"question": "Куда&nbsp;можно написать, если остались вопросы?",
								"answer": '<p>По&nbsp;любым вопросам о&nbsp;VK AdBlogger можете обращаться в&nbsp;Поддержку: <a href="vk.cc/cyEF76" target="_blank">vk.cc/cyEF76</a>.</p>'
							},
							// {
