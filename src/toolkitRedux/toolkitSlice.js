	...
	cases: [
		{
			...
			"blocks": [
				...
				},
				{
					"block_type": "text",
					"title": "",
					"text": "<h2>Вывод</h2> <p>«Успех размещений на 90 % зависит от креатива. В нашем случае использовать в качестве медиаматериалов то, что “было под рукой”, — скорее ошибка. Сейчас на создание креативов для посевов мы выделяем отдельные ресурсы.</p> <p>И также важно учитывать, что реклама в сообществах ВКонтакте сработает, еслиу вас действительно есть товар, который заинтересует потребителя. В этом случае посевы — это ещё одна возможность донести такой товар до клиента», — бренд-менеджер компании «Леврана».</p>"
				}
			]
		},
		{
			...
			"card_label": "Образовательная онлайн-платформа",
