				...
				},
				{
					...
					"block_state": {
						"faqList": [
							...
							{
								"question": "Можно ли монетизировать в VK AdBlogger личную страницу ВКонтакте?",
								"answer": '<p> Да, личные страницы могут зарабатывать на шопсах — через раздел «Товары». Он доступен только тем профилям, которые подходят под критерии программы: не менее 1000 подписчиков, не менее 1 поста или клипа за последние 30 дней. </p> <p> Зарабатывать с помощью посевов и контента на заказ сейчас могут только сообщества. </p>'
							},
							{
							...
							{
								"question": "Моя личная страница не прошла проверку. Можно подать заявку снова?",
							...
							},
							{
								...
								"answer": '<p> К монетизации можно подключить только один профиль — тот, который привязан к вашему VK ID. Другие личные страницы добавить не получится. </p>'
							},
							// {
