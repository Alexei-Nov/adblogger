						...
						"elems_list": [
							{
								...
								"content": "<ul> <li>Получите охваты, размещая рекламу у&nbsp;десятка авторов одновременно</li> <li>Найдёте сообщества с&nbsp;низкой стоимостью рекламы и&nbsp;масштабируете кампанию без&nbsp;больших расходов</li> </ul>"
							},
							{
								...
								"content": "<ul> <li>Получите высокую вовлечённость: как&nbsp;правило, аудитория хорошо реагирует на&nbsp;авторскую рекламу</li> <li>Сможете сотрудничать с&nbsp;крупными авторами&nbsp;— по&nbsp;выгодным ценам, без&nbsp;рисков и&nbsp;бумажной волокиты</li> </ul>"
							}
						]
					}
				},
					...
					"block_state": {
						"faqList": [
							...
							},
							{
								...
								"answer": '<p id="anchor-calculator">Опубликовать контент со сторонней ссылкой не получится. В тексте поста и описании клипа может быть только ссылка на товар Ozon, которая прикреплена к заявке в VK AdBlogger. Это нужно, чтобы посчитать количество продаж именно из вашей публикации.</p>'
							},
							{
