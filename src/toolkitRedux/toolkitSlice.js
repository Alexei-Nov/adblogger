			...
			"blocks": [
				...
				},
				{
					...
					"block_state": {
						...
						"list": [
							...
							{
								"text": "Тематика сообщества <br>соответствует <u><a href='https://adblogger.vk.com/documents/groups_moderation' target='_blank'>требованиям</a></u>"
							}
						],
				...
				// },
				{
					...
					"block_state": {
						...
						"desc": "<p> Это рейтинг с денежными призами для авторов шопсов. Каждая продажа из публикаций продвигает автора в рейтинге и повышает шанс на вознаграждение </p> <p> Чтобы узнать о старте шопс-чарта, следите за <span class='blue-text'>сообществом</span> </p>",
						"img": "./img/timer/img.png",
						"date_start": "2025-10-11T00:00:00Z",
					}
				},
				{
					"block_slug": "advices",
					...
					"block_state": {
						"faqList": [
							...
							},
							{
								...
								"answer": '<ol><li>Создайте кабинет в&nbsp;VK&nbsp;AdBlogger. Как это сделать&nbsp;&mdash; рассказали в&nbsp;статье</li><li>Авторизуйтесь на&nbsp;adblogger.vk.com и&nbsp;найдите раздел &laquo;Товары&raquo; в&nbsp;левом меню</li><li>В&nbsp;каталоге выберите товар для продвижения и&nbsp;нажмите &laquo;Взять в&nbsp;работу&raquo;</li><li>Напишите пост о&nbsp;товаре или снимите клип. В&nbsp;описание добавьте ссылку на&nbsp;товар из&nbsp;заявки&nbsp;&mdash; платформа автоматически прикрепит товар к&nbsp;публикации</li><li>Отправьте контент на&nbsp;модерацию&nbsp;&mdash; обычно она занимает не&nbsp;больше суток</li><li>Когда контент пройдёт модерацию, запланируйте дату публикации</li></ol><p>Кампания по&nbsp;продвижению длится 30&nbsp;дней&nbsp;&mdash; она начинается в&nbsp;тот момент, когда пост или клип будет опубликован. Вы&nbsp;получите проценты за&nbsp;продажи, которые произойдут по&nbsp;вашей ссылке в&nbsp;этот период.</p>'
							},
							{
							...
							},
							{
								...
								"answer": '<p> Лимиты распространяются на&nbsp;одно сообщество: </p> <ul> <li>если вы&nbsp;взяли в&nbsp;работу суммарно 5&nbsp;заявок только в&nbsp;одном сообществе, то&nbsp;в&nbsp;нём сможете взять ещё 5&nbsp;заявок, а&nbsp;в&nbsp;остальных&nbsp;&mdash; всё так&nbsp;же 10 </li> <li>если у&nbsp;вас в&nbsp;работе одновременно 3&nbsp;заявки в&nbsp;одном сообществе, то&nbsp;в&nbsp;нём брать новые заявки пока не&nbsp;получится. В&nbsp;других ваших сообществах это сделать можно&nbsp;&mdash; их&nbsp;лимит не&nbsp;расходуется </li> </ul>'
							},
							{
