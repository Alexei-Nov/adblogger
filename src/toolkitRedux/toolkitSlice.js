					...
					"block_state": {
						"faqList": [
							...
							},
							{
								...
								"answer": '<p> В рамках тестирования профили могут зарабатывать на шопсах — через раздел «Товары». Для этого страница должна подходить под критерии: открытый профиль, не менее 1000 подписчиков, не менее 1 поста или клипа за последние 30 дней. А у вас должен быть статус самозанятого. </p> <p> Другие способы заработка в VK AdBlogger профилям пока недоступны. </p>'
							},
							{
