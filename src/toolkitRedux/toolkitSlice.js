					...
					"block_state": {
						...
						"elems_list": [
							...
							},
							{
								...
								"content": "<ul> <li>Получите высокую вовлеченность аудитории — на&nbsp;авторскую рекламу аудитория реагирует лучше</li> <li>Сможете сотрудничать с&nbsp;крупными авторами по&nbsp;выгодным ценам без&nbsp;лишней бумажной волокиты и&nbsp;рисков</li> </ul>"
							}
						]
					}
				},
					...
					"block_state": {
						...
						"cases_list": [
							...
							},
							{
								...
								"elems_list": [
									{
										"label": "Число продаж на&nbsp;Wildberries <b>выросло</b>",
										"text": "выросло на&nbsp;20%",
									},
									{
