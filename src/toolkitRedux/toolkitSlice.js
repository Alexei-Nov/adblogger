...
const defaultState = {
	...
	cases: [
		...
		},
		{
			...
			"desc": "Общеобразовательные и программы дополнительного профессионального образования",
			...
			"brand_name": "Общеобразовательные и программы дополнительного профессионального образования",
			"tags": [
				{
					"created_at": "2024-10-17T01:58:12.000000Z",
					"id": 2,
			...
			"blocks": [
				{
					"block_type": "text",
					"title": "",
					"text": "<p>Команда агентства a <a href='https://faqmarketing.ru/' target='_blank'>FAQMarketing</a>  и клиент MyFamilySchool протестировали VK AdBlogger, чтобы проверить, удастся ли привлечь потенциальных клиентов из ВКонтакте на посадочную страницу и получить регистрации на обучающие курсы по более низкой стоимости.</p>"
				},
				{
					"block_type": "tile",
					"tile_items": [
				...
				},
				{
					"block_type": "text",
					"title": "",
					"text": "<h2>О рекламодателе</h2> <p>MyFamilySchool запускает общеобразовательные и программы дополнительного профессионального образования: Школа отношений, психологический практикум «Управление своей жизнью» и коучинг. Основная цель посадочной страницы проекта — сбор регистраций на бесплатные курсы, в конце которых клиенты могут записаться на платные программы длительностью от 3 месяцев до 1 года.</p>"
				},
				{
					"block_type": "text",
					"title": "",
