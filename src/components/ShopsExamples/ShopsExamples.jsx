...
export default function ShopsExamples({ block_state }) {
	...
	const [controlledSwipers, setControlledSwipers] = useState([]);

	const addControlledSwiper = (swiper) => {
		setControlledSwipers((prev) => [...prev, swiper]);
	};
				...
				<div className="container">
					...
					<div className="shops-examples__wrapper">
						<Swiper
							...
							controller={{ control: controlledSwipers }}
						...
						<Swiper
							className="shops-examples__slider-author"
						...
						>
							{block_state.cards_list.map((slide, i) => {
								return (
									<SwiperSlide key={i} className="shops-examples__author">
						...
						<Swiper
							className="shops-examples__slider-product"
							modules={[Controller]}
							onSwiper={addControlledSwiper}
							spaceBetween={0}
							speed={800}
						...
						>
							{block_state.cards_list.map((slide, i) => {
								return (
									<SwiperSlide key={i} className="shops-examples__product">
						...
						<div className="shops-examples__bg">
