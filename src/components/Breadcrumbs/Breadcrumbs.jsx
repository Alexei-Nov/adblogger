...
export default function Breadcrumbs({ breadcrumbsState }) {
	...
	return (
		<div className="breadcrumbs text-22">
			<div className="container">
				<div className="breadcrumbs__wrapper ">
					{breadcrumbsState.map((breadcrumb, index) => {
						...
						return (
							<div key={index} className='breadcrumbs__link'>
								{isLast ? (
									<span className="breadcrumbs__current" dangerouslySetInnerHTML={{ __html: title }}></span>
								) : (
									<>
