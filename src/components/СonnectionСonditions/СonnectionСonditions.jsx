				...
				<div className="container">
					...
					<div className="connection-conditions__wrapper">
								...
								{block_state.list.map((item, i) => {
									return (
										<div key={i} className="connection-conditions__list-item">
											...
											<div className="connection-conditions__list-text text-22 fw-500" dangerouslySetInnerHTML={{ __html: item.text }}></div>
										</div>
									)
								})}
						...
						<div className="connection-conditions__right">
							<div className="connection-conditions__right-text text-22" dangerouslySetInnerHTML={{ __html: block_state.desc }}></div>
