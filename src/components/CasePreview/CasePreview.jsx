				...
				<div className="container">
					<div className="case-preview__wrapper">
						...
						<div className="case-preview__card">
							<div className="case-preview__img">
						...
						<div className="case-preview__bottom" ref={wrapper}>
							<div className="case-preview__bottom-body" ref={textBody}>
								...
								<a href={block_state.btn_link} className="case-preview__btn btn btn_wide btn_border-black btn_rounded text-20 fw-500">{block_state.btn_text}</a>
							</div>
