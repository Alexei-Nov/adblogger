...
export default function CasesCatalog() {
	...
	let tagsArr = ['Авторам', 'Бизнесу']
	let cardsArr = [
		{
			pagePath: '/case-1',
			imgPath: '/img/caseCards/img-1.png',
			title: '1 Кинопоиск: как сделать CPA дешевле в два раза и причём здесь лимитированные промокоды',
			label: 'VK Знакомства',
			tag: 'Авторам',
		},
		{
			pagePath: '/case-2',
			imgPath: '/img/caseCards/img-2.png',
			title: '2 Кинопоиск: как сделать CPA дешевле в два раза и причём здесь лимитированные промокоды',
			label: 'VK Знакомства',
			tag: 'Авторам',
		},
		{
			pagePath: '/case-3',
			imgPath: '/img/caseCards/img-3.png',
			title: '3 Кинопоиск: как сделать CPA дешевле в два раза и причём здесь лимитированные промокоды',
			label: 'VK Знакомства',
			tag: 'Бизнесу',
		},
		{
			pagePath: '/case-1',
			imgPath: '/img/caseCards/img-1.png',
			title: 'Кинопоиск: как сделать CPA дешевле в два раза и причём здесь лимитированные промокоды',
			label: 'VK Знакомства',
			tag: 'Авторам',
		},
		{
			...
			<div className="container">
				...
				<div className="cases-catalog__wrapper">
					{resultCardsArr.map((card, i) => {
						return (
							<Link to={card.pagePath} className="cases-catalog__card" key={i}>
								...
								<div className="cases-catalog__name text-21">
									{card.title}
								</div>
